...
``` shell
cmake ..                # Either, use CUDA (default),

cmake -DHIP_ON=ON ..    # or, use HIP (NOT both!)
```
...
The GPU version for ECSIM/RelSIM is currently under development. Keep checking periodically for updates.
